        ...
        <center>
            ...
            <div style="display: flex;">
                <div style="flex-grow: 1; background-color: #ddffdd; border: #00000033 solid 1px; margin: 5px;">
                    ...
                    <form>
                        <!-- <input type="button" value="All Users (Non-JSON)" onclick="callAPI('userlistNonJSON', '1')"> -->
                ...
                <div style="flex-grow: 1; background-color: #ffddff; border: #00000033 solid 1px; margin: 5px;">
                    <p style="font-size: 1.5em; margin: 20px 0px 10px 0px;">
                        Access as Admin
                    </p>
                    <form>
